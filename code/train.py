...
with tf.Graph().as_default():
    ...
    with sess.as_default():
        ...
        out_dir = os.path.abspath(os.path.join(os.path.dirname('../data/vector.txt'), "runs", timestamp))
        print("Writing to {}\n".format(out_dir))
        ...
        for batch in batches:
            ...
            if num_batch == num_batches_per_epoch:
                num_epoch += 1
                num_batch = 1
                if num_epoch % 1 == 0 and (num_epoch > 20 or num_epoch == 3):
                    ...
                    save_path = saver.save(sess, checkpoint_dir+'test.ckpt')
