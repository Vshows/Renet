...
class DataManager:
    ...
    def load_word2vec(self):
        ...
        wordvector = list(open("../data/vector.txt", "r", encoding='utf-8').readlines())
        ...
        #print((self.index2vector[1:30]))

    def load_relations(self):
        # load relation from file
        relation_data = list(open("../data/relation2id.txt", encoding='utf-8').readlines())
    ...
    def load_training_data(self, filename="../data/train.txt", distant_supervision=True):
        ...
        for data in training_data:
            entity1 = data[0]
            entity2 = data[1]
            if data[2] not in self.relations:
                relation = self.relations["unknown"]
            else:
                relation = self.relations[data[2]]
            s = Sentence(entity1, entity2, relation, data[3:-1])
    ...
    def load_testing_data(self):
        ...
        print("====================")
        testing_data = list(open("../data/test.txt").readlines())
    ...
    def load_test_data(self,url):
        # load training data from file
        print("Start loading testing data.")
        print("====================")
        testing_data = list(open(url).readlines())
        testing_data = [s.split() for s in testing_data]
        # for data in testing_data:
        for data in testing_data:
            entity1 = data[0]
